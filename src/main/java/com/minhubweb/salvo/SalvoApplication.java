...
public class SalvoApplication {
	...
	public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository,
		...
		return (args) -> {
			...
			shipSet1.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("B4", "B5"))));
			shipSet2.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet2.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("F1", "F2"))));
			shipSet3.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet3.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet4.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet4.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("G6", "H6"))));
			shipSet5.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet5.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet6.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet6.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("G6", "H6"))));
			shipSet7.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet7.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet8.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet8.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("G6", "H6"))));
			shipSet9.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet9.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet10.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet10.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("G6", "H6"))));
			shipSet11.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet11.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet12.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet12.add(new Ship (ShipType.PATROL, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet13.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet13.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("G6", "H6"))));
