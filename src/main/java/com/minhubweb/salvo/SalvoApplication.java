...
public class SalvoApplication {
	...
	public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository,
		...
		return (args) -> {
			...
			shipSet9.add(new Ship (ShipType.PATROLBOAT, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet10.add(new Ship (ShipType.SUBMARINE, new ArrayList<>(Arrays.asList("A2", "A3", "A4"))));
			shipSet10.add(new Ship (ShipType.PATROLBOAT, new ArrayList<>(Arrays.asList("G6", "H6"))));
			shipSet11.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet11.add(new Ship (ShipType.PATROLBOAT, new ArrayList<>(Arrays.asList("C6", "C7"))));
			shipSet12.add(new Ship (ShipType.DESTROYER, new ArrayList<>(Arrays.asList("B5", "C5", "D5"))));
			shipSet12.add(new Ship (ShipType.PATROLBOAT, new ArrayList<>(Arrays.asList("C6", "C7"))));
